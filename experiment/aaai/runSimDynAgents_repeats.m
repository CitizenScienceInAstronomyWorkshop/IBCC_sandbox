...
x_0_trec = cell(1, nRepeats);
aucs_dyn0_trec  = cell(1, nRepeats);
lam_dyn0_trec  = cell(1, nRepeats);

x_10_trec  = cell(1, nRepeats);
aucs_dyn10_trec  = cell(1, nRepeats);
lam_dyn10_trec  = cell(1, nRepeats);

x_25_trec  = cell(1, nRepeats);
aucs_dyn25_trec  = cell(1, nRepeats);
lam_dyn25_trec  = cell(1, nRepeats);

x_50_trec  = cell(1, nRepeats);
aucs_dyn50_trec  = cell(1, nRepeats);
lam_dyn50_trec  = cell(1, nRepeats);

x_75_trec  = cell(1, nRepeats);
aucs_dyn75_trec  = cell(1, nRepeats);
lam_dyn75_trec  = cell(1, nRepeats);
...
for repeat=1:nRepeats
    ...
    runSimDynAgents_trec
    
    x_0_trec{repeat} = x;
    aucs_dyn0_trec{repeat} = aucs;
    lam_dyn0_trec{repeat} = lam;  
