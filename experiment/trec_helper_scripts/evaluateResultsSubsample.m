function [ aucs ] = evaluateResultsSubsample( selectedDocs, P, Tsorted, fileMapFile, topicDocNoPairsFile, qRels, noGraphs )
...
%   Detailed explanation goes here
    ...
    for d=1:nPairs
        ...
        %if topic is not included in this subsample
        if isempty(topic)
            continue;
        else
	  topic
