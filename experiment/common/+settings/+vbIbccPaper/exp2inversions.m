...
%Ibcc
expSettings.propKnown = [0 0.1 0.25];%[0 0.01 0.02];%[0 0.05 0.1 0.15 0.2 0.25];
...
expSettings.topSaveDir = '/homes/49/edwin/matlab/combination/data/vbIbccPaper_temp/exp2_inv';%exp2_inv_nknownsmall';%exp2inv_itstest';%exp2_inv_nknownsmall';
