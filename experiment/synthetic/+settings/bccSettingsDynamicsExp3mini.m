...
%Ibcc
expSettings.propKnown = [0.2 0.4];%[0 0.05 0.10 0.15 0.20 0.25 0.30 0.35 0.40 0.45];
...
expSettings.topSaveDir = '/homes/49/edwin/matlab/combination/data/dynamicVB/bccDynamicsExp3mini';
...
expSettings.definiteSwitch = [0.5];%[0.03 0.06 0.13 0.16 0.22 0.25 0.32 0.35 0.44 0.47 0.54 0.57 0.63 0.67 0.73 0.77 0.83 0.87 0.93 0.97];%[0.12 0.28 0.44 0.56 0.68 0.8];%
