...
exp_settings.lambdaSym = [0.1, 0.3, 0.5, 0.7, 0.9];
exp_settings.iLambdaSym = 1;

exp_settings.lambdaMag = [100 200 300]; %[1 10 50 100];
...
exp_settings.top_save_dir = '/homes/49/edwin/matlab/combination/data/bccLambda2';
exp_settings.noOverwriteData = true;
%exp_settings.expLabel = 'dlrCombiners'; %experiment label
exp_settings.expLabel = 'lambdaTests';
