...
exp_settings.top_save_dir = '/homes/49/edwin/matlab/combination/data/bccExp3WM';%bcc3Hard';
exp_settings.noOverwriteData = true;
%exp_settings.expLabel = 'dlrCombiners'; %experiment label
exp_settings.expLabel = 'comparisonMinorityInformed';
...
%data generation
exp_settings.means = [-3 -2 -1 ; 3 2 1 ];
...
exp_settings.num_noninf_sensors = 27;
...
exp_settings.nInformedAgents = 4;
