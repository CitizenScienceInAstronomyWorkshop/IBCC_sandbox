...
exp_settings.top_save_dir = '/homes/49/edwin/matlab/combination/data/bcc4HardWM';%bcc3Hard';
exp_settings.noOverwriteData = true;
%exp_settings.expLabel = 'dlrCombiners'; %experiment label
exp_settings.expLabel = 'comparisonHard';
...
%data generation
exp_settings.means = [-3 -2 -1 3 2 -1 -1 -0.5 -0.5 -1; 3 2 1 -3 -2 1 1 0.5 0.5 1];

%test with sensors all of same quality
exp_settings.deviations = [1 2 1 3 1 2 2 2 2 2; 1 1 2 1 3 2 2 2 2 2];
...
exp_settings.num_inf_sensors = 9;
exp_settings.num_noninf_sensors = 21;
