...
%Ibcc
expSettings.propKnown = [0.1 0.2];%[0 0.05 0.1 0.15 0.2 0.25 0.3 0.35 0.4 0.45];%[0 0.05 0.15 0.25];
...
expSettings.topSaveDir = '/homes/49/edwin/matlab/combination/data/dynamicVB/simple/exp3';
...
expSettings.fakeAgents(:, :, 4) = [ 0.99 0.01; 0.19, 0.81 ]; % 90% correct agent
