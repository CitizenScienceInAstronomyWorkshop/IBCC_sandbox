...
expSettings.topSaveDir = '/homes/49/edwin/matlab/combination/data/dynamicVB/simple/exp2';
...
expSettings.fakeAgents(:, :, 3) = [ 0.9 0.1; 0.1, 0.9 ]; % 90% correct agent
expSettings.fakeAgents(:, :, 4) = [ 0.9 0.1; 0.1, 0.9 ]; % 90% correct agent
...
for a=11:40
    ...
    expSettings.fakeAgents(:, :, a) = [ 0.5+r1 r1; r2 0.5+r2 ];
end
