function [expSet, synthSet, bccSet, rerun, range, varName] = dyn7(i)
    ...
    expSet.setDirNames([rootForAllExpts '/exp7/']);
...
%     synthSet.means = [synthSet.means repmat(synthSet.means(:,end), 1, synthSet.nAgents-5)];
    ...
    synthSet.defNoiseChanges = [350 350 350 350 350 350 700 700 700 700];%[140 280 420 560 700 840];
end