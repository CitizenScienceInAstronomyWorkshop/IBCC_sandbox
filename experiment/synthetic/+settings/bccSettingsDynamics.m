...
%IBCC
exp_settings.propKnown = [0 0.05 0.15 0.35 0.45 0.25 ];
...
exp_settings.top_save_dir = '/homes/49/edwin/matlab/combination/data/bccDynamicsSingle';
...
exp_settings.spreadTargets = true;
...
exp_settings.definiteSwitch = [0.3 0.6];
...
exp_settings.nInformedAgents = 3;

exp_settings.max_sensors = 2;
