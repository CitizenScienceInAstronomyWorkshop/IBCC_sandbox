...
expSettings.topSaveDir = '/homes/49/edwin/matlab/combination/data/simple_base_classifiers/exp3';
...
expSettings.fakeAgents = dlmread('/homes/49/edwin/matlab/combination/data/bccExp3vb/baseData/ibccvb');
expSettings.fakeAgents = reshape(vbPi, 2, 2, 40);
