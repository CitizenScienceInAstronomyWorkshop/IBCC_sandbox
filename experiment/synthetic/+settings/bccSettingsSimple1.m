...
expSettings.propKnown = [0 0.1 0.25 0.5 0.6 1];
...
expSettings.nDatasets = 4;
expSettings.nRepeats = 1;

expSettings.nSamples = 2000;
...
expSettings.topSaveDir = '/homes/49/edwin/matlab/combination/data/dynamicVB/simple/exp0_playground3';
...
%data set sizes
expSettings.nTrainingSamples = 100;
...
expSettings.fakeAgents(:, :, 1) = [ 0.7 0.3; 0.3 0.7 ]; % 90% correct agent
expSettings.fakeAgents(:, :, 2) = [ 0.7 0.3; 0.3 0.7 ]; % 90% correct agent
expSettings.fakeAgents(:, :, 3) = [ 0.7 0.3; 0.3, 0.7 ]; % 90% correct agent
expSettings.fakeAgents(:, :, 4) = [ 0.9 0.1; 0.2, 0.8 ]; % 90% correct agent
...
expSettings.fakeAgents(:, :, 9) = [ 0.6 0.4; 0.4 0.6 ]; % fairly useless agent
expSettings.fakeAgents(:, :, 10) = [ 0.6 0.4; 0.4 0.6 ]; % fairly useless agent

import combiners.bcc.ibccsampling.GibbsSampling
