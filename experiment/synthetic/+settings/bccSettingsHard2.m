...
exp_settings.top_save_dir = '/homes/49/edwin/matlab/combination/data/bcc3HardIbcc';
...
exp_settings.deviations = [1 2 0.5 3 0.8; 1 0.5 0.9 0.1 3];
...
exp_settings.num_inf_sensors = 10;
exp_settings.num_noninf_sensors = 20;
