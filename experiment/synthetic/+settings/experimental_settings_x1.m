...
exp_settings.num_inf_sensors = 1;
exp_settings.num_noninf_sensors = 1;

exp_settings.p_switch = 0.017; % probability that a sensor will stop being useful

%agents and sensor allocation
exp_settings.num_agents = 5;

exp_settings.max_sensors = 2;
exp_settings.min_sensors = 1;

%number of clusters and clustering window length
exp_settings.sequence_length = 1;
exp_settings.K = 2;