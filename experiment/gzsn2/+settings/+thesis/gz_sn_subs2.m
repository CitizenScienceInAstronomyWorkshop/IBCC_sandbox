%TRY to copy the original settings from the first NIPS poster
%May be slightly different because of slight changes to the interpretation
%of GZSN labels.
...
expSet.minAgentResp = 50; %min no. responses for a frequently-responding agent 
expSet.minFreqAgents = 10; %min number of freqently-responding agents per data point
expSet.startNegAssets = 1;
expSet.maxNoAssets =1000;
...
% bccSet.Alpha(1,1) = bccSet.Alpha(1,1) + 10;

%use this for the "real" class proportions
bccSet.nu = {[3 3]}; %***? keep this??
