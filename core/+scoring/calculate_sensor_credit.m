function [ sensor_acc_credit ] = calculate_sensor_credit( agents, nAgents, nSensors, nSamples, classifications, results )
    ...
    for n=1:nSamples
        for a=1:nAgents
            ...
            if classification ~= -1
                ...
                agent_credit = scoring.calculate_agent_sensor_credit(agent, classification, logit);
