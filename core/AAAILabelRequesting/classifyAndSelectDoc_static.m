function [samplesToRequest, P, binaryRes, pairsRes, origTsorted] = classifyAndSelectDoc_static( ...
    nToTry, nRequests, featureFile, labelFile, outputRequestFile, ...
    outputResultFile, topicDocNoPairsFile, fileMapFile, Alpha0, Nu0, ...
...
if strcmp(classifierType, 'VB')
    ...
    combiner.useLikelihood = useLikelihood;
